...
Twitter.prototype.startStream = function () {
  ...
  self.twitConn.stream(
    self.twitMethod, 
    {
      ...
      locations: self.twitOptions.locations,
...
Twitter.prototype.checkDistance = function (data) {
  var self = this;
// Removed because it was causing all sorts of errors - Rob Hawkes
// Thus, it must be assumed that no "distance" checking is being made on tweets
...
// Renamed for time-being because it overwrote something in Hook.io
// "Error: You are attempting to override prototype method: "follow". This is probably a bad idea."
Twitter.prototype._follow = function (id) {
  var self = this;
